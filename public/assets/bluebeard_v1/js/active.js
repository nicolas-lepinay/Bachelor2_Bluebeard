...
===================================================
    ...
    Dropdown
    Loading Screen
    Send product's data to quick-view modal
...
/*=============  Product Activation  ==============*/
    ...
    var furnitureOwl2 = $('.furniture--3');
    furnitureOwl2.owlCarousel({
      loop: true,
      nav: false,
      autoplay: false,
      autoplayTimeout: 10000,
    ...
    //javascript
    $('.customNextBtn').click(function() {
      furnitureOwl2.trigger('next.owl.carousel');
    })
    // Go to the previous item
    $('.customPrevBtn').click(function() {
        // With optional speed parameter
        // Parameters has to be in square bracket '[]'
        furnitureOwl2.trigger('prev.owl.carousel', [300]);
    })
...
/*====== CheckOut Page ======*/
    ...
    $('.differt__address').on('click' , function(){
        ...
        $("#ship_to_same_address").prop('checked', true); // Check quand je clique sur le label
    });
  //   $('#ship_to_same_address').on('click' , function(){
  //     $("#ship_to_same_address").prop('checked', !$("#ship_to_same_address").prop('checked'));
  // });

  /*====== L'adresse de livraison est identique : checked par défaut ======*/
  // $(window).on("load", function() {
  //   $("#ship_to_same_address").prop('checked', true);
  // })
...
// Fade in success modal on load :
$(window).on("load", function() {
  $('.modal__wrapper').fadeIn("slow");

})

/*====== Send Data to Quick-View Modal ======*/
// function sendDataToModal() {
//   console.log("CLICKED");
// }
// const sendDataToModal = (string) => {
//   $('#quickview-modal-title').text("Hello there");
// }
...
function addToWishlist(self) {
  $.ajax(
    $(self).data('root') + 'product/wishlist/' + $(self).data('id'),
    {
        success: function(response) {
          // Réponse :
          console.log(response);
          // Change icon color to crimson red :
          $(self).toggleClass('is-liked');
          // Change title attribute :
          let title;
          if($(self).hasClass('is-liked')) {
        ...
        error: function() {
          alert("Ce produit n'a pas pu être ajouté aux favoris.");
        }
     }
  );
}
